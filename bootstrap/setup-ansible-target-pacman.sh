#!/bin/bash
#
# This script prepares an Arch Linux based system to be an Ansible managed node.
# It installs OpenSSH, Python 3, and configures SSH access.
#
# USAGE: Run this script as root, passing the target user's name as an argument.
# Example: ./setup-ansible-target-pacman.sh myuser
#
